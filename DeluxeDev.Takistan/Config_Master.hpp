...
class Life_Settings {
    ...
    save_veh_items[] = { "manualcarbomb","engineBomb","bandage","lockpick","cprkit","timedcarbomb","pickaxe","fuelEmpty","fuelFull","spikeStrip","crowbar","treefixer","panicbutton","ziptie", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts","rabbit","salema","ornate","mackerel","tuna","mullet","catshark","turtle_soup","hen","rooster","sheep","goat" };
    ...
    gang_price = 0; //Price for creating a gang, remember they are persistent so keep it reasonable to avoid millions of gangs.
    ...
    paycheck_period = 4; //Scaled in minutes

    /* Impound Variables */
    impound_car = 2000; //Price for impounding cars
    impound_boat = 2000; //Price for impounding boats
    impound_air = 3000; //Price for impounding helicopters / planes
    impound_tank = 10000;
    ...
    /* Vehicle Settings */
    vehicleShop_rentalOnly[] = { "RHS_Mi8AMTSh_vvs","RHS_Mi8MTV3_vvs","O_Heli_Light_02_F","I_Heli_light_03_F","B_Heli_Light_01_armed_F","rhsgref_cdf_b_reg_uaz_spg9", "rhsgref_mi24g_CAS", "rhs_t80", "rhs_Ob_681_2", "rhs_bmp2k_vdv", "rhs_bmp2e_vdv", "rhs_bmp1d_vdv", "rhs_bmp1_vdv" };
