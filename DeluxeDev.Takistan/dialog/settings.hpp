class SettingsMenu
{
	...
	class controlsBackground
	{
		...
		class RevealNearestHeader : SideChatHeader
		{
			idc = -1;
			text = "$STR_SM_SC";
			y = 0.48;
	...
	class controls
	{
		...
		class VD_onfoot_value : Life_RscEdit
		{
			idc = 2902;
			text = "";
			onChar = "[_this select 0, _this select 1,'ground',0] call life_fnc_s_onChar;";
			onKeyUp = "[_this select 0, _this select 1,'ground',1] call life_fnc_s_onChar;";
		...
		class VD_car_value : Life_RscEdit
		{
			idc = 2912;
			text = "";
			onChar = "[_this select 0, _this select 1,'vehicle',0] call life_fnc_s_onChar;";
			onKeyUp = "[_this select 0, _this select 1,'vehicle',1] call life_fnc_s_onChar;";
		...
		class VD_air_value : Life_RscEdit
		{
			idc = 2922;
			text = "";
			onChar = "[_this select 0, _this select 1,'air',0] call life_fnc_s_onChar;";
			onKeyUp = "[_this select 0, _this select 1,'air',1] call life_fnc_s_onChar;";
