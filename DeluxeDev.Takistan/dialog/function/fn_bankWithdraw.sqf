...
if(_val > 999999) exitWith {hint "You cannot withdraw more than $999,999 at a time!";};
if(_val < 0) exitwith {};
...
if(BANK == 0) exitWith {
["<t size='3.2' color='#e57300'>You cannot withdraw money when you have nothing in your bank!</t>"] call life_fnc_alerttwo;
closeDialog 1;
};
