...
_Btn10 = _display displayCtrl _Btn10;
...
_Btn8 buttonSetAction "[[],'life_fnc_removeWeaponActionCiv',cursorTarget,false] call life_fnc_MP;";

_Btn9 ctrlSetText localize "STR_pInAct_RemoveWeapons2";
_Btn9 buttonSetAction "[[],'life_fnc_stripPlayer',cursorTarget,false] call life_fnc_MP;";

_Btn10 ctrlSetText localize "STR_pInAct_RevokeLicenses";
_Btn10 buttonSetAction "[life_pInact_curTarget] call life_fnc_revokeLicense;";
//_Btn9 ctrlEnable false;

if(!((player distance (getMarkerPos "cop_spawn_1") < 100) OR  (player distance (getMarkerPos "cop_spawn_2") < 100) OR (player distance (getMarkerPos "cop_spawn_3") < 50) OR (player distance (getMarkerPos "JAIL") < 50))) then  {
