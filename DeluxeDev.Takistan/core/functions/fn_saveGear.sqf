...

{
	...
	"pickaxe","netting","generator","light","shovel","fuelEmpty","fuelFull","ziptie","cprkit","bandage", "spikeStrip", "lockpick", "defuseKit","storageSmall","storageBig","redgull","coffee","waterBottle","apple","peach","tbacon","donuts",
	"rabbit","panicbutton","crowbar","mackerel","tuna","mullet","treefixer","turtle_soup","hen","rooster","sheep","goat"
];
