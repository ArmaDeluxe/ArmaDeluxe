...
["<t size='3.2' color='#e57300'>No vehicle found.</t>"] call life_fnc_alerttwo;
};
if(isNull _vehicle) exitWith {};
_storetext="";
[_vehicle,false,(_this select 1),_storetext] remoteExec ["TON_fnc_vehicleStore",RSERV];
["<t size='3.2' color='#e57300'>You have parked the vehicle in your garage.</t>"] call life_fnc_alerttwo;
